...
import type { SurahReference, SurahData, Ayah, QuranEdition, QuranFont, Collections, SavedItem, FontSize, BrowsingMode } from './types.ts';
import { useNotebook } from './hooks/useNotebook.ts';
import { AuthProvider } from './hooks/useAuth.ts';
import SurahDetailView from './components/SurahDetailView.tsx';
import { SearchView } from './components/SearchView.tsx';
import SettingsView from './components/SettingsView.tsx';
import AdminView from './components/AdminView.tsx';
import LoadingScreen from './components/LoadingScreen.tsx';
import TopProgressBar from './components/TopProgressBar.tsx';
import CommentsCloudView from './components/CommentsCloudView.tsx';
import SavedView from './components/SavedView.tsx';
import SaveItemModal from './components/SaveItemModal.tsx';
import SidePanel from './components/SidePanel.tsx';
import AudioPlayerBar from './components/AudioPlayerBar.tsx';
import Toolbox from './components/Toolbox.tsx';
import KhatmiyahView from './components/KhatmiyahView.tsx';
import AudioKhatmiyahView from './components/AudioKhatmiyahView.tsx';
import ThemeToggleButton from './components/ThemeToggleButton.tsx';
import EditionChoiceModal from './components/EditionChoiceModal.tsx';
import HomeView from './components/HomeView.tsx';
import UpdateNotification from './components/UpdateNotification.tsx';
import { ArrowUpIcon, SearchIcon, MenuIcon, MicrophoneIcon } from './components/icons.tsx';
